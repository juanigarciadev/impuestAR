...
export default function Services() {
  ...
  return (
    <section className="flex flex-col w-full gap-2">
      <h3 className="font-bold text-xl text-center">Precios de suscripciones con impuestos</h3>
        ...
        <div className="flex items-center justify-center w-screen h-screen bg-black/40 fixed top-0 left-0 p-4">
          <div className="bg-white rounded-lg w-[440px] p-10 border border-neutral-300">
            <div className="flex items-center justify-between mb-6 w-full">
                ...
                <div>
                    <button onClick={handleCloseModal} className="w-full border text-neutral-500 text-sm px-4 py-2 rounded hover:bg-neutral-100 duration-200 select-none">X</button>
                </div>
            </div>
